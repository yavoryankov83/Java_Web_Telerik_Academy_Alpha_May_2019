...
import com.telerikacademy.furniture.commands.RemoveFurnitureFromCompany;
...
public class RemoveFurnitureFromCompany_Tests {
    ...
    public void before() {
        ...
        testCommand = new RemoveFurnitureFromCompany(furnitureRepository, furnitureFactory);
    ...
    public void execute_should_findFurniture_when_passedCorrectInput() {
        ...
        // Assert
        Assert.assertEquals(0, testCompany.getFurnitures().size());
    }
}
